# Meu primeiro commit de um arquivo README.md

Fiz cópia do arquivo README.md do github [aprenda-git
/pull-request] e fiz alterações para aprender a trabalhar com arquivos no formato Markdown.

Um ótimo local para obter informações sobre o formato Markdown é o [markdownguide.org](https://www.markdownguide.org/basic-syntax/), onde podemos ver inumeras Syntax usadas com frequência neste formato.


## Exemplo de um arquivo README.md:
# Pull request
